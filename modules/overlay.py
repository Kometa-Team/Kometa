...
types_for_var = {
    ...
    "movie_show_season_episode": ["tmdb_rating", "imdb_rating"],
    "movie_show_season": ["original_title", "trakt_user_rating", "omdb_rating", "mdb_rating", "mdb_average_rating", "mdb_imdb_rating",
