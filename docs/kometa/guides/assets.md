...
=== "ASSET_FOLDERS=True"
    ...
    | Collection/Movie/Show square art | `<path_to_assets>/ASSET_NAME/square_art.ext`               |
    ...
    | Season square art                | `<path_to_assets>/ASSET_NAME/Season##_square_art.ext`      |
    ...
    | Episode square art               | `<path_to_assets>/ASSET_NAME/S##E##_square_art.ext`        |
...
=== "ASSET_FOLDERS=False"
    ...
    | Collection/Movie/Show square art | `<path_to_assets>/ASSET_NAME_square_art.ext`               |
    ...
    | Season square art                | `<path_to_assets>/ASSET_NAME_Season##_square_art.ext`      |
    ...
    | Episode square art               | `<path_to_assets>/ASSET_NAME_S##E##_square_art.ext`        |
