...
=== "IMDb Award"
    ...
    | `event_year`<sup>1</sup>  | Specify the year of the Event to look at. **This attribute is required.**<br>**Options:** Any year, list of years, or year range (ex. `2000-2009` or `2000-latest`) from the years under the Event History Sidebar on an Event page. |
