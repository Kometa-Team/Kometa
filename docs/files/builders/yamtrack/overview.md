...
You can find items using lists from your [YamTrack](https://github.com/FuzzyGrim/YamTrack) instance.
...
| [`yamtrack_tracked`](tracked.md)| Finds tracked movies/shows by YamTrack status.   | :fontawesome-solid-circle-check:{ .green } | :fontawesome-solid-circle-check:{ .green } | :fontawesome-solid-circle-check:{ .green } |
