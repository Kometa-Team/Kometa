...
| [`tracearr_watched_media`](history.md#tracearr-watched-media) | Gets the distinct set of watched or partially watched items. | :fontawesome-solid-circle-check:{ .green } | :fontawesome-solid-circle-check:{ .green } | :fontawesome-solid-circle-check:{ .green } |
