...
| `delete_below_minimum`       | **Description:** Deletes the definition if below the minimum.<br>**Default:** [`delete_below_minimum`](../config/settings.md#delete-below-minimum) setting value in the Configuration File<br>**Values:** `true` or `false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `delete_not_scheduled`       | **Description:** Deletes the definition if its skipped because its not scheduled.<br>**Default:** [`delete_not_scheduled`](../config/settings.md#delete-not-scheduled) setting value in the Configuration File<br>**Values:** `true` or `false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `hub_priority`               | **Description:** Sets the position priority for this collection's Recommendation Hub row. Collections with `hub_priority` are sorted to the front of the hub list (lowest number first) before any `auto_sort_hubs` ordering is applied. Requires the collection to be promoted to a hub via `visible_library`, `visible_home`, or `visible_shared` (Plex Pass Required).<br>**Default:** None<br>**Values:** Integer greater than 0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `ignore_ids`                 | **Description:** definition level `ignore_ids` which is combined with the library and global `ignore_ids`.<br>**Default:** [`ignore_ids`](../config/settings.md#ignore-ids) setting value in the Configuration File<br>**Values:** List :material-information-outline:{ data-tooltip data-tooltip-id="tippy-yaml-lists" } or comma-separated String of TMDb/TVDb IDs                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `ignore_imdb_ids`            | **Description:** definition level `ignore_imdb_ids` which is combined with the library and global `ignore_imdb_ids`.<br>**Default:** [`ignore_imdb_ids`](../config/settings.md#ignore-imdb-ids) setting value in the Configuration File<br>**Values:** List :material-information-outline:{ data-tooltip data-tooltip-id="tippy-yaml-lists" } or comma-separated String of IMDb IDs                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| `limit`                      | **Description:** Used to specify the max number of items for the definition<br>**Values:** Number greater than 0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `minimum_items`              | **Description:** Minimum items that must be found to add to a definition.<br>**Default:** [`minimum_items`](../config/settings.md#minimum-items) setting value in the Configuration File<br>**Values:** number greater than 0                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `missing_only_released`      | **Description:** definition Level `missing_only_released` toggle.<br>**Default:** [`filter_unreleased`](../config/settings.md#missing-only-released) setting value in the Configuration File<br>**Values:** `true` or `false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `only_filter_missing`        | **Description:** definition Level `only_filter_missing` toggle.<br>**Default:** [`only_filter_missing`](../config/settings.md#only-filter-missing) setting value in the Configuration File<br>**Values:** `true` or `false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `save_report`                | **Description:** definition level `save_report` toggle.<br>**Default:** [`save`](../config/settings.md#save-report) setting value in the Configuration File<br>**Values:** `true` or `false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `show_filtered`              | **Description:** definition level `show_filtered` toggle.<br>**Default:** [`filtered`](../config/settings.md#show-filtered) setting value in the Configuration File<br>**Values:** `true` or `false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `show_missing`               | **Description:** definition level `show_missing` toggle.<br>**Default:** [`missing`](../config/settings.md#show-missing) setting value in the Configuration File<br>**Values:** `true` or `false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `show_unfiltered`            | **Description:** definition level `show_unfiltered` toggle.<br>**Default:** [`unfiltered`](../config/settings.md#show-unfiltered) setting value in the Configuration File<br>**Values:** `true` or `false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `sync_mode`                  | **Description:** Used to change how builders sync with this definition.<br>**Default:** [`sync_mode`](../config/settings.md#sync-mode) setting value in the Configuration File<br>**Values:** `sync` or `append`<br>See main [settings page](../config/settings.md#sync-mode)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
