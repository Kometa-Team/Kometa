...
=== "String Filters"
    ...
    **Modifiers:** No Modifier, `.not`, `.is`, `.isnot`, `.begins`, `.ends`, or `.regex`
    ...
    |:-------------------------------------------------------------------------------------------------------|:-----------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | audio_codec :material-numeric-8-circle:{ data-tooltip data-tooltip-id="tippy-filters-string-2" }       | Uses the audio codec tags to match       | Movies<br>Shows :material-numeric-8-circle:{ data-tooltip data-tooltip-id="tippy-filters-string-2" }<br>Seasons :material-numeric-8-circle:{ data-tooltip data-tooltip-id="tippy-filters-string-2" }<br>Episodes<br>Tracks                                                                                                                                                                          |
