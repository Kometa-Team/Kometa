...
| `font_style_<<key>>`   | **Description:** Font style for this key's Variable Fonts. The valid values depend on the font; the default font (`fonts/Inter-Medium.ttf`) exposes `Thin`, `ExtraLight`, `Light`, `Regular`, `Medium`, `SemiBold`, `Bold`, `ExtraBold`, `Black`. For other fonts, the runtime error message lists the valid options.<br>**Values:** Variable Font Style |
