...
{%
    ...
    replace-tags='{"rec-sub": "Requirements: Use the [Mass Content Rating Update Library Operation](../../config/operations.md#mass-metadata-update) with either `mdb` or `omdb` to update Plex to the FSK Rating."}'
    end='<!--table-before-->'
%}
