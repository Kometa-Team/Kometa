...
{%
    ...
    replace='{
        ...
        "DESCRIPTION": "an overlay based on ratings from various sources including IMDb, TMDb, MDBList, OMDb, AniDB, MAL, and Rotten Tomatoes on each item within your library"
    }'
