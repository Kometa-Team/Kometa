...
{%
    ...
    replace='{
        ...
        "DESCRIPTION": "an overlay based on ratings from various sources including IMDb, TMDb, Floppy, MDBList, OMDb, AniDB, MAL, Serializd, and Rotten Tomatoes on each item within your library"
    }'
