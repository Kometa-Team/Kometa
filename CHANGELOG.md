...
- Reduce Plex metadata reload payloads during library operations by excluding unused cast, crew, and media elements, preventing poster operations from failing on very large shows. #3519
