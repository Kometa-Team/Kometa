...
- Prevent already-suppressed overlays from executing their own suppression rules, which could remove every overlay from movies matching both resolution and edition Defaults. Fixes #3565.
