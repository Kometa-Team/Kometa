...
- Add `trakt` as a `mass_image_update` source for posters, backgrounds, and logos. Square art remains unsupported.
- Add `tvdb` as a `mass_image_update` source for posters, backgrounds, logos and square art.
