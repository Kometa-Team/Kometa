...
- Update requirements
- Cache completed mass image operation sources per library and image type to prevent unnecessary reapplication. Set `ignore_locked: false` to force a rerun; its default is now `true`.
