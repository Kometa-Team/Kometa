...
- Add `mass_metadata_update.labels.reset: true` to remove all labels except `Overlay` from processed items, optionally before reapplying IMDb parental labels via `labels.severity`.
