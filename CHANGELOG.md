...
- Refresh Plex items and rebuild rating-key mappings after `split_duplicates` replaces metadata records, preventing later operations and overlays in the same run from requesting obsolete rating keys. #3519
