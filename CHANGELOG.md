...
- `modules/plex.py`: handle Plex collection move failures as `Failed` without retrying known 400/404/401 responses or wrapping exhausted retries in `RetryError`; the error now includes the item title and original Plex response.
